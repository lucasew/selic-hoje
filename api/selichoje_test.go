...
// TestParse validates the internal CSV parsing logic used by the API handler.
// Nuance: Uses a mocked, static string payload based on actual historical output
// instead of making a live API request to ensure test determinism and reliability.
